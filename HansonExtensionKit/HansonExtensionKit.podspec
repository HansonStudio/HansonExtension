#
#  Be sure to run `pod spec lint HansonExtensionKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Hanson"
  # s.authors            = { "Hanson" => "hansenhs21@live.com" }
  # s.social_media_url   = "http://twitter.com/Hanson"
